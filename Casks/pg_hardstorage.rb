cask "pg_hardstorage" do
  ...
  on_macos do
    on_arm do
      ...
      sha256 "23149dc952d2191c2a3aa81772008d6d504100290e0708d1dc0ea9def9d89687"
    end
  end
  on_linux do
    on_intel do
      ...
      sha256 "34b012753282f46c45785593c4b3ed24e6bedb9a419e110bfb78a2a63745720b"
    end
    on_arm do
      ...
      sha256 "31e7794353a497462c8580d38432831c6d82116ef6b8ecac3fb2185056fa1b0e"
    end
  end
